...
export default class OP03_073_669 extends Card {
    ...
    public static archetypes: string[] = ["Water 7","Franky Family"];
    ...
    public getArchetypes(): string[] {
        return OP03_073_669.archetypes;
    }
    
    public getPower(): number {
        return OP03_073_669.power;
    }

    public getCounter(): number {
        return OP03_073_669.counter;
    }

    public getLife(): number {
        return OP03_073_669.life;
    }
}
